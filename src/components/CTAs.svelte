...
<div class="flex items-center gap-5 mt-10">
    <a
        ...
        aria-label="LinkedIn"
        target="_blank"
        class="flex h-12 w-12 items-center justify-center text-gray-500 transition-colors hover:text-gray-700 dark:hover:text-gray-300"
    >
        <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-12 w-12 text-gray-500 transition-colors hover:text-gray-700 dark:hover:text-gray-300"
            fill="currentColor"
            viewBox="0 0 24 24"
        >
            <path
