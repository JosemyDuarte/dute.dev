...
export default function Home() {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-black p-4 text-white">
      ...
      <footer className="absolute bottom-8 flex space-x-4">
        <a
          href="https://www.linkedin.com/in/josemyduarte/"
          aria-label="LinkedIn"
          target="_blank"
          className="flex h-12 w-12 items-center justify-center text-gray-500 transition-colors hover:text-gray-700 dark:hover:text-gray-300"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-12 w-12 text-gray-500 transition-colors hover:text-gray-700 dark:hover:text-gray-300"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
